...
if("FALSE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/capra/Ibex/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/capra/Ibex/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/capra/Ibex/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/capra/Ibex/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
