...
if("FALSE" STREQUAL "TRUE")
  set(laser_scan_splitter_SOURCE_PREFIX /home/capra/Ibex/src/scan_tools/laser_scan_splitter)
  set(laser_scan_splitter_DEVEL_PREFIX /home/capra/Ibex/devel)
  ...
  set(laser_scan_splitter_INSTALL_PREFIX /home/capra/Ibex/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_scan_splitter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_scan_splitter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/capra/Ibex/install/${idir}'.  Ask the maintainer 'Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
    endif()
