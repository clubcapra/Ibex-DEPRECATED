...
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ObstaclePluginConfig::AbstractParamDescriptionConstPtr(new ObstaclePluginConfig::ParamDescription<int>("combination_method", "int", 0, "Method for combining two layers", "{'enum_description': 'Method for combining layers enum', 'enum': [{'srcline': 10, 'description': 'Overwrite values', 'srcfile': '/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Overwrite'}, {'srcline': 11, 'description': 'Take the maximum of the values', 'srcfile': '/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Maximum'}, {'srcline': 12, 'description': 'Do nothing', 'srcfile': '/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'cconsttype': 'const int', 'value': 99, 'ctype': 'int', 'type': 'int', 'name': 'Nothing'}]}", &ObstaclePluginConfig::combination_method)));
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Overwrite = 0;
//#line 11 "/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Maximum = 1;
//#line 12 "/home/capra/Ibex/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
